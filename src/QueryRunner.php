...
class QueryRunner
{
    ...
    public function __construct (Connection &$connection, ?string $database = null, ?string $table = null, bool $auto_type = false)
    {
        // (Getting the values)
    ...
    # Returns [QueryRunner]
    public static function create (Connection &$connection, ?string $database = null, ?string $table = null, bool $auto_type = false)
    {
        // Returning the value
        return new QueryRunner( $connection, $database, $table, $auto_type );
    }
